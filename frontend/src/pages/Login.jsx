      ...
      <div className="liquid-glass p-8 md:p-10 rounded-[32px] max-w-md w-full z-10 transition">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full liquid-glass-button text-white font-extrabold py-3.5 px-4 rounded-2xl shadow-lg transition disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
